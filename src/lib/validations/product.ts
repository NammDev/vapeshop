...
export const addProductSchema = z.object({
  ...
  inventory: z.number(),
  images: z.custom<File[] | undefined | null>().optional().nullable().default(null),
})
...
export type GetProductInventorySchema = z.infer<typeof getProductInventorySchema>
export type GetProductsSchema = z.infer<typeof getProductsSchema>
export type UpdateProductRatingSchema = z.infer<typeof updateProductRatingSchema>
