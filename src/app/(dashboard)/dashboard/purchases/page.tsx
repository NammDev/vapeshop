...
import { PurchasesTable } from '@/components/table/purchases-table'
      ...
      const data = await tx
        ...
        .where(
          and(
            ...
            // Filter by store
            typeof store === 'string' ? like(stores.name, `%${store}%`) : undefined,
            // Filter by status
  ...
  return (
    <Shell variant='sidebar'>
      <PageHeader>
        ...
        <PageHeaderDescription size='sm'>Manage your purchases</PageHeaderDescription>
      </PageHeader>
