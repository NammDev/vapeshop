...
export default async function CustomersPage({ params, searchParams }: CustomersPageProps) {
  ...
  const { page, per_page, sort, email, from, to } = customersSearchParamsSchema.parse(searchParams)
  ...
  return (
    <div className='space-y-6'>
      ...
      <React.Suspense fallback={<DataTableSkeleton columnCount={5} filterableColumnCount={0} />}>
