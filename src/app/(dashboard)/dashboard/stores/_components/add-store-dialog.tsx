...
function AddStoreForm({ children, form, onSubmit, className, ...props }: AddStoreFormProps) {
  return (
    <Form {...form}>
      <form
...
function DynamicTrigger({ progress, showTrigger, isDesktop }: DynamicTriggerProps) {
