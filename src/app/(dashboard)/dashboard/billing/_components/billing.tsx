...
export async function Billing({}: //   subscriptionPlanPromise,
  ...
  const subscriptionPlans = [
    {
      ...
      stripePriceId: 'price_1JZxYpL6b0lB4Pb3Jkzr5P2d',
    },
    {
      title: 'Pro',
      description: 'Unlock more features and customization',
      price: '$29',
      features: ['Create up to 1 store', 'Create up to 20 products'],
      stripePriceId: 'price_1JZxYpL6b0lB4Pb3Jkzr5P2d',
    },
    {
      ...
      price: '$99',
      features: ['Unlimited stores', 'Unlimited products', 'Custom domains'],
      stripePriceId: 'price_1JZxYpL6b0lB4Pb3Jkzr5P2d',
    },
  ]
      ...
      <Card>
        <CardHeader>
          ...
          <div className='text-sm text-muted-foreground'>
            ...
            <Badge variant='secondary' className='pointer-events-none text-foreground/90'>
