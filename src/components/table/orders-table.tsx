...
// import { getStripePaymentStatusColor, stripePaymentStatuses } from '@/lib/checkout'
...
export function OrdersTable({ promise, storeId, isSearchable = true }: OrdersTableProps) {
