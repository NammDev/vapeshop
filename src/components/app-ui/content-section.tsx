    ...
    <section className={cn('space-y-6', className)} {...props}>
      <div className='flex items-center justify-between gap-4'>
        <div className='max-w-[58rem] flex-1 space-y-1'>
          <h2 className='font-heading text-3xl font-bold leading-[1.1] md:text-4xl'>{title}</h2>
          {description ? (
      ...
      <div className='space-y-8'>
        <ChildrenShell
          className={cn(!asChild && 'grid gap-4 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4')}
        >
          {children}
        </ChildrenShell>
