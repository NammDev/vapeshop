...
const newsletterImages = [
  ...
  },
  {
    ...
    creditUrl: 'https://www.pexels.com/photo/skateboarder-jumping-a-skateboard-5037502/',
          ...
          <Container className='mx-auto my-[40px] max-w-2xl rounded p-4'>
            <Section className='mt-4'>
              ...
              <Text className='mb-0 mt-6 text-center text-base'>
                {`We're`} so glad {`you're`} here. {`We're`} excited to share our passion for
                skateboarding with you.
              </Text>
            ...
            <Section className='mt-4 text-center text-zinc-400'>
              ...
              <Text className='mb-0 mt-4'>@ Skateshop13 {new Date().getFullYear()}</Text>
              <Text className='m-0'>
